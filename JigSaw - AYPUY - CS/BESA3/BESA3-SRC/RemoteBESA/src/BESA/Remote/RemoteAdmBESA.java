...
public class RemoteAdmBESA extends LocalAdmBESA {
     ...
     *
     * @param admAlias Alias/name of the admnistrador.
     * @return null if this is a problem -> exception in lookup || there is already a local administrator with the same alias and a different name RMI (possible ambiguity by the same names).
     * @throws Exception Exception in lookup.
     */
