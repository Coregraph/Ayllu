...
final public class ChannelBESA implements Runnable {
     ...
     */
    public synchronized void waitBehBarrier() throws KernellAgentExceptionBESA {
        while (barrierCounter > 0) {
            ...
            try {
                ...
                throw new KernellAgentExceptionBESA("Happened an error on wait behavior barrier: " + ie.toString());
            }
     ...
     */
    public synchronized void signalBehBarrier() throws KernellAgentExceptionBESA {
        try {
            ...
            throw new KernellAgentExceptionBESA("Happened an error on signal behavior barrier: " + e.toString());
        }
    }
     ...
     */
    public synchronized void waitlogicChannel() throws KernellAgentExceptionBESA {
        try {
            this.waitlogicChannel = true;
        } catch (Exception e) {
            ReportBESA.error("Happened an error on wait logic channel: " + e.toString());
            throw new KernellAgentExceptionBESA("Happened an error on wait logic channel: " + e.toString());
        }
    }
