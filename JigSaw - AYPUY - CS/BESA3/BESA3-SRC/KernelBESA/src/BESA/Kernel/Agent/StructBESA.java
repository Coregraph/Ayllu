...
public class StructBESA implements Serializable {
    ...
    public void bindGuard(String behaviorName, Class guardClass) throws ExceptionBESA {
        ...
        if(guardList == null) {
            throw new KernellAgentExceptionBESA("Behavior didn't find. Before, you should define the behavior.");
        }
        ArrayList ackList = null;
     ...
     */
    protected void buildAgentStruct(AgentBESA agent) throws KernellAgentExceptionBESA {
     ...
     */
    private Object buildAgentComponent(AgentBESA agent, String name) throws KernellAgentExceptionBESA {
        try {
            ...
            throw new KernellAgentExceptionBESA("Couldn't build agent component: " + ex.toString());
        }
    }
     ...
     */
    private Object buildAgentMultiGuard(MultiGuardBESA guarda, String name) throws KernellAgentExceptionBESA {
        try {
            Class cls = Class.forName(name);
            Class[] partypes = new Class[1]; //2
            ...
            throw new KernellAgentExceptionBESA("Couldn't build agent multi-guard: " + ex.toString());
        }
    }
}
