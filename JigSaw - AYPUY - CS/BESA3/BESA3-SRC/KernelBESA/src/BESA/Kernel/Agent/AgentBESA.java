...
public abstract class AgentBESA {
     ...
     */
    public AgentBESA(String alias, StateBESA state, StructBESA structAgent, double passwd) throws KernellAgentExceptionBESA {
...
//******************************************************************************                
            ...
            throw new KernellAgentExceptionBESA("Couldn't create an instance the agent " + this.alias + ": " + e.toString());
        } //End catch.
    }
     ...
     */
    public void sendEvent(EventBESA ev) throws KernellAgentExceptionBESA {
        try {
            ...
            throw new KernellAgentExceptionBESA("Couldn't send the event: " + e.toString());
        } //End catch.
    }
     ...
     */
    final public void move(double passwd) throws KernellAgentExceptionBESA {
            ...
            synchronized (alive) {                                              //Synchronized access to the variable alive.
                if (this.isAlive().booleanValue()) {                            //Checks if is alive.
                    ...
                    try {
                        ...
                        throw new KernellAgentExceptionBESA("Couldn't move the agent " + this.alias + ": " + e.toString());
                    }
                }
            }
        }
     ...
     */
    final protected int startBehaviors() throws KernellAgentExceptionBESA {
     ...
     * @param passwd Password of the agent.
     */
    final protected void killBehaviors(double passwd) throws KernellAgentExceptionBESA {
     ...
     * @param passwd Password of the agent.
     */
    final public void joinBehaviors(double passwd) throws KernellAgentExceptionBESA {
        if (Math.abs(this.passwd - passwd) < 0.00001) {
            for (int i = 0; i < behaviors.size(); ++i) {                        //Sync the end of the threads of the behaviors associated.
                ...
                try {
                    ...
                    throw new KernellAgentExceptionBESA("Couldn't join behaviors." + ie.toString());
                } //End catch.
            } //End for.
        } //End if.
    }
     ...
     */
    public synchronized void waitChannelReady() throws KernellAgentExceptionBESA {
        try {
            ReportBESA.trace("Before of waitChannelReady.");
            this.wait();
        } catch (InterruptedException ie) {
            ReportBESA.error("Happened an error on wait channel ready:" + ie.toString());
            throw new KernellAgentExceptionBESA("Happened an error on wait channel ready:" + ie.toString());
        }
    }
    ...
    public void init() throws KernellAgentExceptionBESA {
        try {
            ...
            throw new KernellAgentExceptionBESA("Happened an error on setup the agent: " + alias + ", message: " + e.toString());
        }
    }
     ...
     */
    public synchronized void waitChannel() throws KernellAgentExceptionBESA {
        try {
            ...
            throw new KernellAgentExceptionBESA("Happened an error on wait channel:" + ie.toString());
        }
    }
