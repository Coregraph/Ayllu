...
public class GuardOdoModify extends GuardBESA {
    ...
    public boolean funcEvalBool(StateBESA objEvalBool) {
        ...
        if (counter.getValue() < 1000) {                                        //Checks if activated the condition.
            return true;
        } else {
            return false;
        }
    ...
    /**
     * Functon executed guard.
     *
     * @param dataEvent Event with DataOdo data. DataOdo contains the posible
     * menssage: increments (INC) and decrements (DEC).
     * @see GuardMoveOdo
     * @see DataOdo
     */
    @Override
