...
public class DatosDiscusion extends DataBESA{
    ...
    private int numeroEstudiantesRta;
    ...
    public int getNumeroEstudiantesRta() {
        return numeroEstudiantesRta;
    }

    public void setNumeroEstudiantesRta(int numeroEstudiantesRta) {
        this.numeroEstudiantesRta = numeroEstudiantesRta;
    }
