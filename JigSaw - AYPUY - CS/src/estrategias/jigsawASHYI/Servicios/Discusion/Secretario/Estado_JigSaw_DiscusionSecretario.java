 ...
 * @author yolima
 */
public class Estado_JigSaw_DiscusionSecretario extends CommunityAgentState{
    ...
    public Estado_JigSaw_DiscusionSecretario (List<AgentRole> sameVolatileGroupHandlers, AgHandlerBESA sessionManagerHandler, AgHandlerBESA communityManagerHandler) 
