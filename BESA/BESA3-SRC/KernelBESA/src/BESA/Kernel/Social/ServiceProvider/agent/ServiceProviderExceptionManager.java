...
public class ServiceProviderExceptionManager extends ServiceProviderBESA {
     ...
     * @param myRobots
     */
    public ServiceProviderExceptionManager(String alias, StateServiceProvider state, StructBESA structAgent, double passwd, ArrayList<Integer> myRobots) throws KernellAgentExceptionBESA {
