...
public class MBoxBESA {
     ...
     */
    final protected synchronized EventBESA receiveEvent() throws KernellAgentExceptionBESA {
        while (queue.isEmpty()) {                                               //Checks if there are events into queue.
            try {
                ...
                throw new KernellAgentExceptionBESA("Happened an error on wait time of receive event: " + ie.toString());
            }
        }
